      ...
      <Wrapper>
        <Details>
          <StyledDetailsLeft>
            ...
            <div className="tags">
              {data.tags ? data.tags.map((tag, index) => <p key={index}>#{tag}</p>) : ""}
            </div>
